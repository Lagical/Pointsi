...
/* harmony default export */ __webpack_exports__["default"] = ("<ion-header [translucent]=\"true\">\r\n  <ion-toolbar>\r\n    <ion-buttons slot=\"start\">\r\n      <ion-back-button [hidden]=\"!open4\" [disabled]=\"!open4\"defaultHref=\"companies\"\r\n      text=\"Takaisin\">\r\n      </ion-back-button>\r\n    </ion-buttons>\r\n    <ion-title>\r\n      Kamera\r\n    </ion-title>\r\n  </ion-toolbar>\r\n</ion-header>\r\n\r\n<ion-content [fullscreen]=\"true\">\r\n <img class=\"kuvat\" style=\"\" [src]=\"image\" />\r\n\r\n\r\n <div class=\"stars\" [hidden]=\"!open\">\r\n  <ion-icon id=\"s5\" class=\"star\" name=\"star\" (click)=\"s5()\"></ion-icon>\r\n  <ion-icon id=\"s4\" class=\"star\" name=\"star\" (click)=\"s4()\"></ion-icon>\r\n  <ion-icon id=\"s3\" class=\"star\" name=\"star\" (click)=\"s3()\"></ion-icon>\r\n  <ion-icon id=\"s2\" class=\"star\" name=\"star\" (click)=\"s2()\"></ion-icon>\r\n  <ion-icon id=\"s1\" class=\"star\" name=\"star\" (click)=\"s1()\"></ion-icon>\r\n</div>\r\n\r\n\r\n <ion-fab vertical=\"bottom\" horizontal=\"center\" slot=\"fixed\">\r\n  <ion-fab-button [hidden]=\"!open2\" [disabled]=\"!open2\" color=\"secondary\" (click)=\"captureImage()\">\r\n    <ion-icon name=\"camera\"></ion-icon>\r\n  </ion-fab-button>\r\n</ion-fab>\r\n<ion-fab vertical=\"bottom\" horizontal=\"center\" slot=\"fixed\">\r\n  <ion-fab-button [hidden]=\"!open1\" [disabled]=\"!open1\" color=\"danger\" (click)=\"shareImage()\" (click)=\"addCredits()\" (click)=\"addStar()\">\r\n    <ion-icon name=\"share\"></ion-icon>\r\n  </ion-fab-button>\r\n</ion-fab>\r\n<ion-fab vertical=\"bottom\" horizontal=\"center\" slot=\"fixed\">\r\n  <ion-fab-button [hidden]=\"!open3\" [disabled]=\"!open3\" color=\"success\" routerLink=\"/main\">\r\n    <ion-icon name=\"home\"></ion-icon>\r\n  </ion-fab-button>\r\n</ion-fab>\r\n</ion-content>\r\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("#container {\n  text-align: center;\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 50%;\n  -webkit-transform: translateY(-50%);\n          transform: translateY(-50%);\n}\n\n#container strong {\n  font-size: 20px;\n  line-height: 26px;\n}\n\n#container p {\n  font-size: 16px;\n  line-height: 22px;\n  color: #8c8c8c;\n  margin: 0;\n}\n\n#container a {\n  text-decoration: none;\n}\n\nion-content ion-toolbar {\n  --background: translucent;\n}\n\n.stars {\n  position: absolute;\n  left: 50%;\n  -webkit-transform: translate(-50%, 0%);\n          transform: translate(-50%, 0%);\n  display: -webkit-box;\n  display: flex;\n  direction: rtl;\n}\n\n.stars ion-icon {\n  cursor: pointer;\n  font-size: 300%;\n  -webkit-transition: 0.3s all;\n  transition: 0.3s all;\n  padding: 10px;\n}\n\n.stars ion-icon:hover {\n  color: gold;\n}\n\n#s1:hover ~ ion-icon {\n  color: gold;\n}\n\n#s2:hover ~ ion-icon {\n  color: gold;\n}\n\n#s3:hover ~ ion-icon {\n  color: gold;\n}\n\n#s4:hover ~ ion-icon {\n  color: gold;\n}\n\n#s5:hover ~ ion-icon {\n  color: gold;\n}\n\nion-toolbar {\n  --background: #80deea;\n}\n\nion-back-button {\n  --color: black;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/fesm2015/ionic-angular.js");
/* harmony import */ var _ionic_native_instagram_ngx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic-native/instagram/ngx */ "./node_modules/@ionic-native/instagram/ngx/index.js");
/* harmony import */ var watermarkjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! watermarkjs */ "./node_modules/watermarkjs/dist/watermark.js");
/* harmony import */ var watermarkjs__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(watermarkjs__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _fb_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../fb.service */ "./src/app/fb.service.ts");
...
let HomePage = class HomePage {
    constructor(camera, loadingController, instagram, db, af) {
        this.camera = camera;
        this.loadingController = loadingController;
        this.instagram = instagram;
        this.db = db;
        this.af = af;
        this.image = "assets/placeholder/logo.png";
        this.open2 = true;
        this.open4 = true;
        this.options = {
            quality: 100,
    ...
    captureImage() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            watermarkjs__WEBPACK_IMPORTED_MODULE_5__([this.baseimg])
                .image(watermarkjs__WEBPACK_IMPORTED_MODULE_5__["text"].center('#' + this.company + " " + "#Pointsi", '200px Josefin Slab', '#fff', 0.5))
                .then(img => {
                this.image = img.src;
            });
            this.open = true;
    ...
    addCredits() {
        ...
        this.af.doc(`users/${this.db.getUID()}`).update({
            history: firebase_app__WEBPACK_IMPORTED_MODULE_8__["firestore"].FieldValue.arrayUnion({
                comp,
                pts,
                time,
                rating
...
HomePage.ctorParameters = () => [
    ...
    { type: _ionic_native_instagram_ngx__WEBPACK_IMPORTED_MODULE_4__["Instagram"] },
    { type: _fb_service__WEBPACK_IMPORTED_MODULE_6__["FbService"] },
...
HomePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_2__["Camera"],
        ...
        _ionic_native_instagram_ngx__WEBPACK_IMPORTED_MODULE_4__["Instagram"],
        _fb_service__WEBPACK_IMPORTED_MODULE_6__["FbService"],
