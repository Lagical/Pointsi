(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main-main-module"], {
  ...
  function srcAppMainMainPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _fb_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../fb.service */
    ...
    let MainPage = class MainPage {
      constructor(routerOutlet, af, alertService, menu, db) {
        ...
        this.points = [];
        this.point = 20;
        this.company = ""; //get data in real time from database to this.user to be displayed on app
          ...
          if (this.userd.credits < this.point) {
            ...
            this.alertService.alerts("Hyväksy ostos", "Oletko varma?", [{
              ...
              handler: () => {
                ...
                this.af.doc("users/".concat(this.db.getUID())).update({
                  credits
                });
                this.db.getUser().subscribe(data => {
                  this.userd = data;
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonRouterOutlet"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__["AngularFirestore"], _alert_service__WEBPACK_IMPORTED_MODULE_5__["AlertService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["MenuController"], _fb_service__WEBPACK_IMPORTED_MODULE_3__["FbService"]])], MainPage);
    /***/
  }
}]);
