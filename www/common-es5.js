(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppAlertServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let AlertService = class AlertService {
      ...
      toasts(message, duration, position) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
  ...
  /***/
  function srcAppFbServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FbService", function () {
      return FbService;
    });
    /* harmony import */
    ...
    let FbService = class FbService {
      constructor(af, afAuth) {
        this.af = af;
        this.afAuth = afAuth; //gets all data of the companies from database to this.companies

        this.companiesCollection = af.collection('companies');
        this.companies = this.companiesCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => {
        ...
        this.users = this.usersCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => {
          return actions.map(a => {
            const data = a.payload.doc.data();
            const id = a.payload.doc.id;
            return Object.assign({
      ...
      storeUser(result, username, credits) {
        this.af.doc("users/".concat(result.user.uid)).set({
          username,
          credits
        });
      ...
      getUser() {
        return this.usersCollection.doc(this.getUID()).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(users => {
          users.uid;
          return users;
        }));
    ...
    FbService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_4__["AngularFireAuth"]])], FbService);
    /***/
  }
}]);
